...
import stylesCss from 'themes/gw-messapp/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/gw-messapp/components/vaadin-button.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_gw-messapp_componentCss']) {
    registerStyles(
      'vaadin-button',
      unsafeCSS(vaadinButtonCss.toString())
    );
    
    document['_vaadintheme_gw-messapp_componentCss'] = true;
  }
