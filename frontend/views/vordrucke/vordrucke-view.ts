...
@customElement('vordrucke-view')
export class VordruckeView extends LitElement {
  connectedCallback() {
      ...
      <main class="max-w-screen-lg mx-auto pb-l px-l">
        <vaadin-horizontal-layout class="items-center justify-between">
          <vaadin-vertical-layout>
            <h2 class="mb-0 mt-xl text-3xl">Vordrucke</h2>
            <p class="mb-xl mt-0 text-secondary">Vordrucke, sortiert nach Einsatzart</p>
          </vaadin-vertical-layout>
